...
class MIMIC(Dataset):
    ...
    def __init__(self, path, version="chexpert", split="train", transform=None, views=["AP", "PA"], unique_patients=False, pretraining=False) :
        super().__init__()
...
# TODO!!
class MIMIC_NLE(Dataset) :
    
    def __init__(self, path, split="train", transform=None, views=["AP", "PA"]) :
        super().__init__()
